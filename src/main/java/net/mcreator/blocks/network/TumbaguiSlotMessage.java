...
public class TumbaguiSlotMessage {
	private final int slotID, x, y, z, changeType, meta;

	public TumbaguiSlotMessage(int slotID, int x, int y, int z, int changeType, int meta) {
		this.slotID = slotID;
		this.x = x;
		this.y = y;
		this.z = z;
	...
	public TumbaguiSlotMessage(FriendlyByteBuf buffer) {
	...
	public static void buffer(TumbaguiSlotMessage message, FriendlyByteBuf buffer) {
	...
	public static void handler(TumbaguiSlotMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
	...
	public static void handleSlotAction(Player entity, int slotID, int changeType, int meta, int x, int y, int z) {
		...
		HashMap guistate = TumbaguiMenu.guistate;
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		QzMod.addNetworkMessage(TumbaguiSlotMessage.class, TumbaguiSlotMessage::buffer, TumbaguiSlotMessage::new, TumbaguiSlotMessage::handler);
	}
}
