...
public class WorbenchslotsSlotMessage {
	private final int slotID, x, y, z, changeType, meta;

	public WorbenchslotsSlotMessage(int slotID, int x, int y, int z, int changeType, int meta) {
		this.slotID = slotID;
		this.x = x;
		this.y = y;
		this.z = z;
	...
	public WorbenchslotsSlotMessage(FriendlyByteBuf buffer) {
	...
	public static void buffer(WorbenchslotsSlotMessage message, FriendlyByteBuf buffer) {
	...
	public static void handler(WorbenchslotsSlotMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
	...
	public static void handleSlotAction(Player entity, int slotID, int changeType, int meta, int x, int y, int z) {
		...
		HashMap guistate = WorbenchslotsMenu.guistate;
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		QzMod.addNetworkMessage(WorbenchslotsSlotMessage.class, WorbenchslotsSlotMessage::buffer, WorbenchslotsSlotMessage::new, WorbenchslotsSlotMessage::handler);
	}
}
