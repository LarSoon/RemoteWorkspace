...
public class SupplyboxSlotMessage {
	private final int slotID, x, y, z, changeType, meta;

	public SupplyboxSlotMessage(int slotID, int x, int y, int z, int changeType, int meta) {
		this.slotID = slotID;
		this.x = x;
		this.y = y;
		this.z = z;
	...
	public SupplyboxSlotMessage(FriendlyByteBuf buffer) {
	...
	public static void buffer(SupplyboxSlotMessage message, FriendlyByteBuf buffer) {
	...
	public static void handler(SupplyboxSlotMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
	...
	public static void handleSlotAction(Player entity, int slotID, int changeType, int meta, int x, int y, int z) {
		...
		HashMap guistate = SupplyboxMenu.guistate;
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		QzMod.addNetworkMessage(SupplyboxSlotMessage.class, SupplyboxSlotMessage::buffer, SupplyboxSlotMessage::new, SupplyboxSlotMessage::handler);
	}
}
