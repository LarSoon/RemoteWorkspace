...
public abstract class Armor2ArmorItem extends ArmorItem {
	public Armor2ArmorItem(EquipmentSlot slot, Item.Properties properties) {
	...
	public static class Chestplate extends Armor2ArmorItem {
		public Chestplate() {
