...
public abstract class Armor1ArmorItem extends ArmorItem {
	public Armor1ArmorItem(EquipmentSlot slot, Item.Properties properties) {
	...
	public static class Chestplate extends Armor1ArmorItem {
		public Chestplate() {
