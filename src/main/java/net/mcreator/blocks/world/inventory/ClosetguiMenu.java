...
import net.mcreator.blocks.network.ClosetguiSlotMessage;
...
public class ClosetguiMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public ClosetguiMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(QzModMenus.CLOSETGUI, id);
		...
		this.customSlots.put(4, this.addSlot(new SlotItemHandler(internal, 4, 25, 44) {
			@Override
			public void onTake(Player entity, ItemStack stack) {
				super.onTake(entity, stack);
				slotChanged(4, 1, 0);
		...
		this.customSlots.put(8, this.addSlot(new SlotItemHandler(internal, 8, 97, 62) {
			@Override
			public void onTake(Player entity, ItemStack stack) {
				super.onTake(entity, stack);
				slotChanged(8, 1, 0);
		...
		this.customSlots.put(9, this.addSlot(new SlotItemHandler(internal, 9, 115, 62) {
			@Override
			public void onTake(Player entity, ItemStack stack) {
				super.onTake(entity, stack);
				slotChanged(9, 1, 0);
	...
	private void slotChanged(int slotid, int ctype, int meta) {
		if (this.world != null && this.world.isClientSide()) {
			QzMod.PACKET_HANDLER.sendToServer(new ClosetguiSlotMessage(slotid, x, y, z, ctype, meta));
			ClosetguiSlotMessage.handleSlotAction(entity, slotid, ctype, meta, x, y, z);
		}
	}
