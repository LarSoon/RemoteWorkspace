...
import net.mcreator.blocks.procedures.WorkbenchslotsOnBlockRightClickedProcedure;
import net.mcreator.blocks.network.WorbenchslotsSlotMessage;
...
public class WorbenchslotsMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public WorbenchslotsMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(QzModMenus.WORBENCHSLOTS, id);
		...
		this.customSlots.put(4, this.addSlot(new SlotItemHandler(internal, 4, 79, 44) {
			@Override
			public void onTake(Player entity, ItemStack stack) {
				super.onTake(entity, stack);
				slotChanged(4, 1, 0);
		...
		this.customSlots.put(5, this.addSlot(new SlotItemHandler(internal, 5, 97, 44) {
			@Override
			public void onTake(Player entity, ItemStack stack) {
				super.onTake(entity, stack);
				slotChanged(5, 1, 0);
		...
		WorkbenchslotsOnBlockRightClickedProcedure.execute(world, x, y, z);
	}
	...
	private void slotChanged(int slotid, int ctype, int meta) {
		if (this.world != null && this.world.isClientSide()) {
			QzMod.PACKET_HANDLER.sendToServer(new WorbenchslotsSlotMessage(slotid, x, y, z, ctype, meta));
			WorbenchslotsSlotMessage.handleSlotAction(entity, slotid, ctype, meta, x, y, z);
		}
	}
