...
public class FuseboxopenMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public FuseboxopenMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(QzModMenus.FUSEBOXOPEN, id);
