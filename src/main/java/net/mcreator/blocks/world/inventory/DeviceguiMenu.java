...
public class DeviceguiMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public DeviceguiMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(QzModMenus.DEVICEGUI, id);
	...
	public static void onPlayerTick(TickEvent.PlayerTickEvent event) {
		...
		if (event.phase == TickEvent.Phase.END && entity.containerMenu instanceof DeviceguiMenu) {
