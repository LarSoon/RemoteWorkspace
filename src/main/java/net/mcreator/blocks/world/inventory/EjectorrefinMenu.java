...
import net.mcreator.blocks.network.EjectorrefinSlotMessage;
...
public class EjectorrefinMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public EjectorrefinMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(QzModMenus.EJECTORREFIN, id);
	...
	private void slotChanged(int slotid, int ctype, int meta) {
		if (this.world != null && this.world.isClientSide()) {
			QzMod.PACKET_HANDLER.sendToServer(new EjectorrefinSlotMessage(slotid, x, y, z, ctype, meta));
			EjectorrefinSlotMessage.handleSlotAction(entity, slotid, ctype, meta, x, y, z);
		}
	}
