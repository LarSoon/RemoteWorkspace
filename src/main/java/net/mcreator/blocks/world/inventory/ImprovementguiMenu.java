...
public class ImprovementguiMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public ImprovementguiMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(QzModMenus.IMPROVEMENTGUI, id);
